...
/**
    ...
    * @retval, 0 on success
    */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(sp_hex_open)(const char* uri, remote_handle64* h) __QAIC_HEADER_ATTRIBUTE;
/** 
    ...
    */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(sp_hex_close)(remote_handle64 h) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(sp_hex_round_trip_f32)(remote_handle64 _h, const float* in_vec, int in_vecLen, int head_dim, float* out_vec, int out_vecLen) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(sp_hex_vht2_forward)(remote_handle64 _h, float* data, int dataLen, int n) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(sp_hex_band_quantize)(remote_handle64 _h, const float* coeffs, int coeffsLen, int head_dim, unsigned char* out_packed, int out_packedLen) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(sp_hex_band_dequantize)(remote_handle64 _h, const unsigned char* in_packed, int in_packedLen, int head_dim, int max_bands, float* out_coeffs, int out_coeffsLen) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(sp_hex_vtcm_status)(remote_handle64 _h, int64* bytes_total, int64* bytes_avail, int64* bytes_acquired) __QAIC_HEADER_ATTRIBUTE;
...
__QAIC_HEADER_EXPORT int __QAIC_HEADER(sp_hex_kq_matmul_fused)(remote_handle64 _h, const float* q_vec, int q_vecLen, const unsigned char* k_packed, int k_packedLen, int head_dim, int n_kv, int n_q, float* kq_scores, int kq_scoresLen) __QAIC_HEADER_ATTRIBUTE;
